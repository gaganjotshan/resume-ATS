...
def main():
    ...
    if not job_description or resume_text is None:
        ...
        if keyword_analysis:
            ...
            You are a skilled ATS (Applicant Tracking System) scanner with a deep understanding of data science, data analytics, machine learning, and related technologies. Your task is to evaluate the provided resume against the job description.
